...
data3 <- data3 %>% arrange(desc(strata), labid) # sort by strata column (decreasing)
...
# Sort clummp orignal pops as numerical order (not character). This is only needed if the populations are numbered and sorted incorrectly by default.
